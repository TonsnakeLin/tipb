...
type PointGet struct {
	...
	ReadTable        *TableInfoDetail `protobuf:"bytes,2,opt,name=read_table,json=readTable" json:"read_table,omitempty"`
	ReadIndex        *IndexInfoDetail `protobuf:"bytes,3,opt,name=read_index,json=readIndex" json:"read_index,omitempty"`
	OutputOffsets    []uint32         `protobuf:"varint,4,rep,name=output_offsets,json=outputOffsets" json:"output_offsets,omitempty"`
	XXX_unrecognized []byte           `json:"-"`
}
...
func (*PointGet) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{9} }

func (m *PointGet) GetEncodeType() EncodeType {
	if m != nil {
		return m.EncodeType
	}
	return EncodeType_TypeDefault
...
func (m *PointGet) GetOutputOffsets() []uint32 {
	if m != nil {
		return m.OutputOffsets
	}
	return nil
...
func (m *PointGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReadTable != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSelect(dAtA, i, uint64(m.ReadTable.Size()))
		n8, err := m.ReadTable.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.ReadIndex != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintSelect(dAtA, i, uint64(m.ReadIndex.Size()))
		n9, err := m.ReadIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
var fileDescriptorSelect = []byte{
	...
	,
}
